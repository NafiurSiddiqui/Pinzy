...
<html lang="en">
  <head>
    ...
    />
    <script
      src="https://kit.fontawesome.com/cf32b5773d.js"
    ...
    <title>Pinzy - Guest user.</title>
  </head>
  <body class="flex bg-primary">
    <!-- sidebar -->
    <aside
    ...
    >
      <div
        class="sidebar-content-wrapper transition-all duration-[400ms] h-screen opacity-0 tablet:opacity-100"
      >
        <!-- nav -->
        <nav
          class="border-b border-zinc-400 py-4 px-4 drop-shadow-sm bg-zinc-400/60"
        >
          <ul class="flex justify-around">
            <li
              class="border-r border-r-1 border-r-gray-300 w-4/5 text-center text-base nav-active"
            >
              Pins
            </li>
            <li
            ...
            >
              <a href="../html/guest.html">Profile</a>
            </li>
          </ul>
        </nav>
        ...
        <!-- pins -->
        <div
          class="pin-container-wrapper__global bg-zinc-700 h-76vh laptop:h-76vh/20"
        >
          <p
            class="default-msg text-center text-zinc-400 font-semibold text-lg top-8 relative italic"
          >
            No pins created yet.
          </p>
          <ul
      ...
      >
        <a
          class="btn-user-logout font-semibold px-4 text-lg flex justify-center rounded-sm ring-4 ring-zinc-300 text-zinc-300 items-center transition-all hover:text-zinc-50 hover:font-bold hover:ring-zinc-200 hover:shadow-lg hover:shadow-zinc-800 hidden tablet:flex"
          href="../../index.php"
          >Logout</a
        >

        <i
          class="btn-sidebar fa-solid fa-chevron-left rounded-sm ring-4 ring-zinc-300 text-zinc-300 p-3 hover:text-zinc-100 hover:font-bold hover:ring-zinc-100 cursor-pointer transition-transform hover:shadow-lg hover:shadow-zinc-800"
        ></i>
      </div>
    </aside>
    <section class="map-content w-full">
      ...
      <div class="ml-4 bg-slate-500">
        <span
          class="font-semibold desktop:ml-6 fixed top-2 right-4 z-20 bg-zinc-400/30 backdrop-blur-sm p-3 rounded-sm"
          >Pinzy</span
        >
      </div>
      ...
      >
        <span
          class="btn-close__user-input absolute bottom-16 tablet-md:top-16 cursor-pointer"
          role="button"
          aria-label="Close"
        >
          <i
            class="fa-sharp fa-regular fa-circle-xmark fa-2xl text-zinc-400 laptop:text-zinc-500 hover:text-zinc-300"
          ></i>
        </span>
        ...
        >
          <div class="flex flex-col my-4 w-full">
            <label class="text-gray-600 text-xs mb-1" for="eventType"
              >Pin type</label
            >
            <select
              name="eventType"
              id="eventType"
              class="p-1 cursor-pointer border border-zinc-300"
            >
          ...
          <div class="flex flex-col w-full">
            <label class="text-gray-600 text-xs mb-1" for="message"
              >Message</label
            >
            <textarea
              class="rounded-sm border border-zinc-300 p-2 resize-none"
              name="message"
              id="message"
              cols="30"
              rows="4"
      ...
      >
        ...
        >
          <div class="flex flex-col my-4 w-full">
            <label class="text-gray-600 text-xs mb-1" for="eventType__edit"
              >Pin type</label
            >
            <select
              name="eventType__edit"
              id="eventType__edit"
              class="p-1 cursor-pointer border border-zinc-300"
            >
              <option value="none">---</option>
          ...
          <div class="flex flex-col w-full">
            <label class="text-gray-600 text-xs mb-1" for="message__edit"
              >Message</label
            >
      ...
      <div class="map-container h-screen z-10 flex justify-center items-center">
        <div
          class="loader-wrapper flex justify-between items-center w-60 absolute top-80"
        >
