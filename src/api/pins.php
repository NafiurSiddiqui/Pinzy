...
<!-- nav -->
<nav class="py-4 px-4 drop-shadow-md shadow-zinc-100 bg-white">
  <ul class="flex justify-around">
    <li class="border-r border-r-1 border-r-gray-300 w-4/5 text-center text-base nav-active">
      Pins
    </li>
    <li class="font-semibold w-4/5 text-center text-base text-zinc-400 hover:text-zinc-500  ">
      <a href="
              <?php
...
<!-- pins -->
<div class="pin-container-wrapper__global bg-zinc-100 h-90vh">
  <p class="default-msg text-center text-zinc-400 font-semibold text-lg top-8 relative italic">
    No pins created yet.
  </p>
  <ul class="global-pin-container hidden px-4 pt-8 pb-4 flex items-center flex-col bg-zinc-200 h-76vh overflow-y-scroll"
    data-userLogged="
    <?php
